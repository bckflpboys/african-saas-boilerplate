...
export default function Footer() {
  return (
    <footer className="bg-black-bg border-t border-gray-800">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Company Info */}
          <div className="col-span-1">
            <h3 className="text-primary text-lg font-bold mb-4">AfriSaaS</h3>
            <p className="text-gray-400 text-sm">
              Building the future of African SaaS applications with modern tools and local integrations.
            </p>
          </div>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/changelog" className="text-gray-400 hover:text-primary transition-colors">
                  Changelog
                </Link>
              </li>
            </ul>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/tutorials" className="text-gray-400 hover:text-primary transition-colors">
                  Tutorials
                </Link>
              </li>
              <li>
        ...
        <div className="mt-8 pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © {new Date().getFullYear()} AfriSaaS. All rights reserved.
            </p>
